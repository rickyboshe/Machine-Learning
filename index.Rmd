...
fig2<-ggplotly(fig2)#%>%config(responsive=TRUE, displayModeBar = FALSE)
...
fig3<-ggplotly(fig3)#%>%config(responsive=TRUE, displayModeBar = FALSE)
...
boro<-ggplotly(boro)#%>%config(boro, displayModeBar = FALSE)
...
This could mean there is a perception bubble amongst teachers, students and parents. Sadly, it does not match reality. 
